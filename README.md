...
* `SQL_queries_Yarmolenko.sql` — повний набір SQL-запитів для вивантаження та первинного аналізу даних.
* `Metrocar_Report_Yarmolenko.pdf` — розгорнутий аналітичний звіт із графіками та висновками.
